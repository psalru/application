# Generated by Django 4.1.4 on 2023-03-09 12:50
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(
                        blank=True,
                        help_text="ID организации как работодателя для работы с HH API",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.IntegerField(
                        blank=True,
                        help_text="ID организации как обр. организации для работы с HH API",
                        null=True,
                    ),
                ),
                (
